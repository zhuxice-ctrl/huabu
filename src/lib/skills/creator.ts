...
export const BUILTIN_SKILL_CREATOR = {
  ...
  description: 'Create, install, or update reusable Agent Skills inside zeroxB. Use when the user asks to create a Skill, build a reusable AI workflow, install the created Skill, or modify an existing Skill.',
  instructions: `# Create or update a zeroxB Skill
...
5. Prefer zeroxB tools and instruction-only Skills. Add scripts only when deterministic execution is genuinely required.
